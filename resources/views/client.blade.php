                ...
                @foreach($clients as $client)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#updateClientModal{{$client->id}}">
                                Edit
                            </button>
                                        ...
                                        <div class="modal-body">
                                            <form action="/clients/{{$client -> id}}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="client-number" name="number" value="{{$client->number}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="client-address">Address:</label>
                                                    <input type="text" class="form-control" id="client-address" name="address" value="{{$client->address}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="client-industry">Industry:</label>
                                                    <input type="text" class="form-control" id="client-industry" name="industry" value="{{$client->industry}}">
                                                </div>
